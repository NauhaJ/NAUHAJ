...
namespace Elainluokat
{
    class program
    {
        static void Main(string[] args)
        {
            ...
            // Luodaan uusi Kissa1 olio KISSA luokasta
            Kissa Kissa1 = new Kissa();
            Kissa1.AsetaElaimenNimi("Ridge");
            Kissa1.AsetaElaimenIka(10);
            Kissa1.AsetaOnlihanSyoja(true);
            Console.WriteLine($"Kissan nimi on {Kissa1.PalautaElaimenNimi()}, kissan ikä on {Kissa1.PalautaElaimenIka()} ja onko kissa lihansyöjä: {Kissa1.PalautaOnLihansyoja()}");
            Kissa1.kehraa();
            Koira Musti = new Koira();
            Musti.AsetaElaimenNimi("Musti");
            Musti.AsetaElaimenIka(16);
            Musti.AsetaOnlihanSyoja(true);
            Console.WriteLine($"Koiran nimi on {Musti.PalautaElaimenNimi()}, koiran ikä on {Musti.PalautaElaimenIka()} ja onko koira lihansyöjä: {Musti.PalautaOnLihansyoja()}");
            Console.ReadLine(); 
